...
scanf("%f %f", &num1, &num2); result = numi+ num2; printf("Result = %.2f\n", result); break:

case 2

printf("Enter two numbers: "); scanf("%f %f", &num1, &num2); result = numl-num2; printf("Result = %.2f\n", result); break:

case 3

printf("Enter two numbers: "); scanf("%f %f", &num1, &num2); result = num1 num2; printf("Result = %.2f\n", result); break;
